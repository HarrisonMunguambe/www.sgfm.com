          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Introduza o seu e-mail e a palavra-passe para criar a conta.
              </p>
            </div>
            <div>
                ...
                <div class="space-y-5">
                  <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-1">
                      <label
                        ...
                        class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                      >
                        Apelido<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="lastName"
                        type="text"
                  ...
                  <div>
                    <label
                      ...
                      class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400"
                    >
                      Palavra-passe<span class="text-error-500">*</span>
                    </label>
                    <div class="relative">
                      <input
                        v-model="password"
          ...
          <div class="flex items-center justify-center z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              ...
              <p class="text-center text-gray-400 dark:text-white/60">
                Modelo de painel administrativo em Tailwind CSS (código aberto)
              </p>
            </div>
          </div>
        </div>
